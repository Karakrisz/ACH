...
<div id="termekek_demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner termekek_carousel">
    ...
    <a class="carousel-control-prev nyilak" href="#demo" data-slide="prev">
        <span class="carousel-control-prev-icon"></span>
    </a>
    <a class="carousel-control-next nyilak" href="#demo" data-slide="next">
