...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 termekeink">
    <h1 class="col-xl-12 col-lg-12 col-md-12 col-sm-12">Vastag <br>lemezek</h1>
    <br>
    <div class="row termekeink_elso_sora">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <div id="termekeink_fuggoleges">
                <p>TERMÉKEK</p>
            </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 termekeink_boxok_01">
            <h5>01</h5>
            <br>
            <h2 class="col-xl-6 col-lg-6 col-md-6 col-sm-6">Hengerelt alumínium lemez</h2>
            <br>
            <p>
                <a href="#">Bővebben</a>
            </p>
    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 termekeink_boxok_02">
            <h5>01</h5>
            <br>
            <h2 class="col-xl-6 col-lg-6 col-md-6 col-sm-6">Alumíminium profilok, szerelvények</h2>
            <br>
            <p>
                <a href="#">Bővebben</a>
            </p>
...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 termekeink_tablazat">

    <table class="table">
        <thead>
        <p class="text-center">Jelölések és tulajdonságok</p>
...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 termekeink_csusztatas">
