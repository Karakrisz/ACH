...
<div id="iso_demo" class="carousel slide" data-ride="carousel">

    <h2 class="col-xl-12 col-lg-12 col-md-12 col-sm-12">ISO</h2>
...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 iso_tartalom">
    <h1>Alaposság</h1>
    <h1>Céltudatosság</h1>
    <h1>Hatékonyság</h1>
    ...
    <p>Budapest 2019.07.25</p>

    <h5 class="text-right">Borbás Ádám ügyvezető</h5>
...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 iso_tartalom">
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 iso_letoltes_tartalom">
        <div class="row iso_letoltes_tartalom_sorai">
