...
<div id="szolgaltatasok_demo" class="carousel slide" data-ride="carousel">

    <h2 class="col-xl-12 col-lg-12 col-md-12 col-sm-12">Szolgáltatások</h2>
...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 szolgaltatsok">
    <h2 class="col-xl-5 col-lg-5 col-md-6 col-sm-6">Alumíminium rudak, profilok, szerelvények</h2>
    <br>
    <div class="row szolgaltatsok_sora">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            ...
            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, tota
            </p>
    ...
    <div class="row szolgaltatsok_sora">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
            <br>
            <h2>Anyagfelhasználás optimalizálás</h2>
            <br>
            <p>
                <a href="#">MEGTAKARITAS</a>
            </p>
    ...
    <div class="row szolgaltatsok_sora">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 szolgaltatsok_elso_sora">
