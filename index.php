...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 test_tartalom">
    <div class="row">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 tulajdonsagok">
            <div>
                <h4>Gyorsaság</h4>
                <p>Házhozszállítást nem igénylő megrendelések esetén 1 napon belül teljesítjük. Házhozszállítást
                    igénylő megrendelések esetén 2-3 napon belül produkáljuk.</p>
            </div>
            <div class="precizitas">
                <h4>Precizitás</h4>
                <p>Házhozszállítást nem igénylő megrendelések esetén 1 napon belül teljesítjük. Házhozszállítást
                    igénylő megrendelések esetén 2-3 napon belül produkáljuk.</p>
            </div>
            <div class="odafigyeles">
                <h4>Odafigyeles</h4>
                <p>Házhozszállítást nem igénylő megrendelések esetén 1 napon belül teljesítjük. Házhozszállítást
                    igénylő megrendelések esetén 2-3 napon belül produkáljuk.</p>
            </div>
...
<div class="container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 slider_tartalom">
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <h2 class="col-xl-12 col-lg-12 col-md-12 col-sm-12">Az Ön sikere <br>a Mi sikerünk</h2>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <h2 class="col-xl-12 col-lg-12 col-md-12 col-sm-12">Minőség</h2>
        </div>
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div>
